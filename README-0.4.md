...
- Current primary-source gaps are most obvious for 5-Amino-1MQ, NAD+, MOTS-c and the approved-label context mentioned but not directly linked for afamelanotide. SS-31 and tesamorelin now have direct FDA label metadata, remain custom-only and require owner review of the newly exposed numeric label details.
