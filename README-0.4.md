...
- Current primary-source gaps are most obvious for 5-Amino-1MQ, NAD+, MOTS-c and the approved-label contexts mentioned but not directly linked for tesamorelin and afamelanotide. SS-31 now has direct FDA label metadata, remains custom-only and requires owner review of the newly exposed numeric label details.
