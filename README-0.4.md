...
- Current primary-source gaps are most obvious for 5-Amino-1MQ, NAD+ and MOTS-c. SS-31, tesamorelin and afamelanotide now have direct FDA label metadata, remain custom-only and require owner review of the newly exposed numeric label details. Afamelanotide also has an exact 2004 human-study protocol, kept separate from the implant label and from retail-vial planning.
