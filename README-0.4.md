...
- The most obvious entry-level primary-source gap is now MOTS-c. NAD+ has a 2019 human intravenous pharmacokinetic pilot, but it establishes neither efficacy nor any non-IV or repeated regimen. 5-Amino-1MQ has an exact 2022 preclinical mouse protocol but retains a complete human-administration evidence gap. SS-31, tesamorelin and afamelanotide have direct FDA label metadata, remain custom-only and require owner review of newly exposed numeric details. Afamelanotide also has an exact 2004 human-study protocol, kept separate from the implant label and retail-vial planning.
