...
| Melanotan I / Afamelanotide | Current U.S. approved-product labeling plus older human subcutaneous and randomized implant research | School now links the August 2024 SCENESSE label and records its proprietary 16 mg controlled-release implant, trained-professional placement and every-two-month frequency. | Approved implant context remains custom-only and its numeric content is flagged for owner review. It supplies no vial-dilution method or injectable-vial schedule; original injection-study extraction remains separate work. |
...
- Current primary-source gaps are most obvious for 5-Amino-1MQ, NAD+ and MOTS-c. SS-31, tesamorelin and afamelanotide now have direct FDA label metadata, remain custom-only and require owner review of the newly exposed numeric label details. Afamelanotide's older injection-study protocol still needs exact extraction separate from its implant label.
