...
export type Database = { public: {
  ...
  Functions: { beta_access: {Args:Record<string,never>;Returns:boolean}; accept_beta_invite: {Args:Record<string,never>;Returns:boolean}; create_initial_planner_copy:{Args:{payload:Json;confirmed:boolean;expected_user_id:string};Returns:number}; export_own_account:{Args:Record<string,never>;Returns:Json}; set_deletion_request:{Args:{cancel_request:boolean};Returns:string} };
