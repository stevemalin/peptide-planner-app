...
export type V04LibraryEntry={
 ...
 deeper:DeepSection[];referenceMode:'existing'|'custom-only';
};
...
export const addedLibraryV04:V04LibraryEntry[]=[
 {id:'5-amino-1mq',name:'5-Amino-1MQ',aliases:['5 amino 1mq','5amino1mq','1mq'],kind:'Small-molecule research compound',accent:'#5A67D8',referenceMode:'custom-only',
  ...
  deeper:[{title:'Research overview',body:'Published work has examined NNMT inhibition in cells and animal metabolic models. The app should keep that evidence separate from human clinical dosing claims.'},{title:'What is known in humans?',body:'The 0.4 library does not encode an established human administration schedule. Custom tracking remains available without labeling it as a published human protocol.'},{title:'Why it is still here',body:'Users may track non-peptide research compounds alongside peptides. Classification is shown clearly rather than forcing everything into one category.'}]},
 {id:'ss-31',name:'SS-31 / Elamipretide',aliases:['ss31','ss-31','elamipretide','mmtp-131'],kind:'Mitochondria-targeting investigational peptide',accent:'#18A0AE',referenceMode:'custom-only',
  summary:'SS-31, also called elamipretide, is a mitochondria-targeting investigational peptide studied in human clinical programs.',
  ...
  evidence:'Human clinical research exists; no universal plan is encoded in 0.4.',studiedFor:'Primary mitochondrial myopathy and other mitochondrial/cardiac research settings.',
 ...
 {id:'nad-plus',name:'NAD+',aliases:['nad','nad+','nicotinamide adenine dinucleotide'],kind:'Endogenous cofactor / metabolite',accent:'#7C5CFF',referenceMode:'custom-only',
  ...
  deeper:[{title:'Route matters',body:'Intravenous NAD+ research is not interchangeable with oral precursor research or other formulations. The app should always keep route/formulation context visible.'},{title:'Human evidence',body:'Human studies include pharmacokinetic and metabolomic work, but evidence is heterogeneous and should not be collapsed into a single recommended schedule.'},{title:'Tracker role',body:'0.4 supports custom tracking so a user can organize a personally selected plan without the School page fabricating a universal reference.'}]},
