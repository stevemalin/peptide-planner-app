...
test('tracker leads with operational today dashboard',()=>{assert.match(tracker,/Today at a glance/);assert.match(tracker,/Needs log/);assert.match(tracker,/Up next/);});
